...
(uuid_from_text('hie-nabidh-uuid'), 'nabidh', 'NABIDH', 'DHA', 'https://api.nabidh.ae/fhir/R4', 'R4', 'oauth2', 
...
(uuid_from_text('hie-malaffi-uuid'), 'malaffi', 'Malaffi', 'DOH', 'https://api.malaffi.ae/fhir/R4', 'R4', 'certificate',
...
(uuid_from_text('hie-riayati-uuid'), 'riayati', 'Riayati', 'MOHAP', 'https://api.riayati.ae/fhir/R4', 'R4', 'oauth2_pkce',
