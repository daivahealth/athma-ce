...
BEGIN
  -- Get IDs
  SELECT id INTO v_facility_id FROM facilities WHERE tenant_id = uuid_from_text('11111111-1111-1111-1111-111111111111') LIMIT 1;
...
WHERE f.tenant_id = uuid_from_text('11111111-1111-1111-1111-111111111111')
