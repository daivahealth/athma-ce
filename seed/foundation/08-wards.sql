...
VALUES
  -- ICU Ward 1
  (uuid_from_text('10000001-0001-0001-0001-000000000001'),
   uuid_from_text('d0000001-0002-0001-0001-000000000001'), -- IPD Department
   'ICU Ward 1', 'ICU-1', 'icu', '3', 0, 0, 'NS-ICU-1', 'active', NOW(), NOW()),
   
  -- ICU Ward 2
  (uuid_from_text('10000001-0001-0001-0001-000000000002'),
...
INSERT INTO wards (id, department_id, name, code, ward_type, floor_number, total_beds, available_beds, nursing_station, status, created_at, updated_at)
VALUES
  (uuid_from_text('10000001-0002-0001-0001-000000000001'),
   uuid_from_text('d0000001-0002-0001-0001-000000000001'),
...
INSERT INTO wards (id, department_id, name, code, ward_type, floor_number, total_beds, available_beds, nursing_station, status, created_at, updated_at)
VALUES
  (uuid_from_text('10000001-0003-0001-0001-000000000001'),
   uuid_from_text('d0000001-0002-0001-0001-000000000001'),
...
INSERT INTO wards (id, department_id, name, code, ward_type, floor_number, total_beds, available_beds, nursing_station, status, created_at, updated_at)
VALUES
  (uuid_from_text('10000001-0005-0001-0001-000000000001'),
   uuid_from_text('d0000001-0002-0001-0001-000000000001'),
