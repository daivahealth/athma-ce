...
SET app.current_tenant_id = uuid_from_text('11111111-1111-1111-1111-111111111111');
...
(uuid_from_text('11111111-1111-1111-1111-111111111111'), NULL, NULL, 'provider',
...
(uuid_from_text('11111111-1111-1111-1111-111111111111'), NULL, 'PED', 'specialty',
...
(uuid_from_text('11111111-1111-1111-1111-111111111111'), uuid_from_text('payer-daman-uuid'), NULL, 'facility',
...
(uuid_from_text('11111111-1111-1111-1111-111111111111'), NULL, 'EMERG', 'provider',
