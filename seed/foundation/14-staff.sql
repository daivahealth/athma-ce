...
-- Doctors
(uuid_generate_v5((SELECT dns FROM ns), 'staff:DOCTOR:AHMED_ALMAN'), '11111111-1111-1111-1111-111111111111', 'Dr', 'Ahmed', 'Al-Mansoori', 'Hassan', DATE '1975-03-15', 'male', 'UAE', '+971501234567', 'ahmed.almansoori@zeal.ae', 'DOC001', 'doctor', '[]'::jsonb, 'MOH-DOC-2024-001', DATE '2026-12-31', 'MD', ARRAY['Arabic','English'], 'Dr Ahmed Al-Mansoori', 'active', NOW(), NOW()),
(uuid_generate_v5((SELECT dns FROM ns), 'staff:DOCTOR:FATIMA_ALZA'), '11111111-1111-1111-1111-111111111111', 'Dr', 'Fatima', 'Al-Zaabi', 'Mohammed', DATE '1980-07-22', 'female', 'UAE', '+971502345678', 'fatima.alzaabi@zeal.ae', 'DOC002', 'doctor', '[]'::jsonb, 'MOH-DOC-2024-002', DATE '2027-06-30', 'FRCP', ARRAY['Arabic','English'], 'Dr Fatima Al-Zaabi', 'active', NOW(), NOW()),
(uuid_generate_v5((SELECT dns FROM ns), 'staff:DOCTOR:OMAR_ALK'), '11111111-1111-1111-1111-111111111111', 'Dr', 'Omar', 'Al-Ketbi', NULL, DATE '1985-11-10', 'male', 'UAE', '+971503456789', 'omar.alketbi@zeal.ae', 'DOC003', 'doctor', '[]'::jsonb, 'MOH-DOC-2024-003', DATE '2027-12-31', 'MBBS', ARRAY['Arabic','English'], 'Dr Omar Al-Ketbi', 'active', NOW(), NOW()),
(uuid_generate_v5((SELECT dns FROM ns), 'staff:DOCTOR:LAYLA_ALSH'), '11111111-1111-1111-1111-111111111111', 'Dr', 'Layla', 'Al-Shamsi', 'Abdullah', DATE '1982-09-25', 'female', 'UAE', '+971505678901', 'layla.alshamsi@zeal.ae', 'DOC004', 'doctor', '[]'::jsonb, 'MOH-DOC-2024-005', DATE '2027-03-31', 'MD', ARRAY['Arabic','English'], 'Dr Layla Al-Shamsi', 'active', NOW(), NOW()),
-- Nurses
