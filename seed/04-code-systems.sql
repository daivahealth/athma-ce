...
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'zeal:visit-category', 'Zeal Visit Category', 
 'Classification of visit types: new, revisit, follow-up', '1.0', 'active', 'Zeal Platform'),
 
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'http://terminology.hl7.org/CodeSystem/icd-10', 'ICD-10', 
 'International Classification of Diseases, 10th Revision', '2021', 'active', 'WHO'),
 
('cccccccc-cccc-cccc-cccc-cccccccccccc', 'http://www.ama-assn.org/go/cpt', 'CPT', 
 'Current Procedural Terminology', '2024', 'active', 'American Medical Association'),
 
('dddddddd-dddd-dddd-dddd-dddddddddddd', 'zeal:encounter-source', 'Encounter Source', 
 'Source/origin of clinical encounters', '1.0', 'active', 'Zeal Platform'),
 
('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'zeal:urgency-level', 'Urgency Level', 
