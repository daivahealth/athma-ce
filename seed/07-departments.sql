...
INSERT INTO departments (id, facility_id, name, code, department_type, floor_number, phone_extension, operating_hours, status, created_at, updated_at)
SELECT
  'd0000001-0003-0001-0001-000000000001',
  id,
  'Emergency Department',
  'ER',
  'emergency',
...
INSERT INTO departments (id, facility_id, name, code, department_type, floor_number, phone_extension, operating_hours, status, created_at, updated_at)
SELECT
  'd0000001-0004-0001-0001-000000000001',
  id,
  'Radiology Department',
  'RAD',
  'radiology',
...
INSERT INTO departments (id, facility_id, name, code, department_type, floor_number, phone_extension, operating_hours, status, created_at, updated_at)
SELECT
  'd0000001-0005-0001-0001-000000000001',
  id,
  'Laboratory Department',
  'LAB',
  'laboratory',
...
INSERT INTO departments (id, facility_id, name, code, department_type, floor_number, phone_extension, operating_hours, status, created_at, updated_at)
SELECT
  'd0000001-0006-0001-0001-000000000001',
  id,
  'Surgery Department',
  'SURG',
  'surgery',
...
INSERT INTO departments (id, facility_id, name, code, department_type, floor_number, phone_extension, operating_hours, status, created_at, updated_at)
SELECT
  'd0000001-0007-0001-0001-000000000001',
  id,
  'Pharmacy Department',
  'PHARM',
  'pharmacy',
