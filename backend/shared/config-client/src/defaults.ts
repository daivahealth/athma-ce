 ...
 */
export const CONFIG_DEFAULTS: Partial<ConfigValues> = {
  // Localization
 ...
 */
export function getDefaultValue<K extends keyof ConfigValues>(
  key: K
): ConfigValues[K] | undefined {
  return CONFIG_DEFAULTS[key] as ConfigValues[K];
}
