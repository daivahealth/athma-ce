...
let EncounterModule = (() => {
    let _classDecorators = [(0, common_1.Module)({
            ...
            providers: [encounter_service_1.EncounterService, encounter_repository_1.EncounterRepository],
            exports: [encounter_service_1.EncounterService, encounter_repository_1.EncounterRepository],
        })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var EncounterModule = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            EncounterModule = _classThis = _classDescriptor.value;
            if (_metadata)
    ...
    return EncounterModule = _classThis;
})();
