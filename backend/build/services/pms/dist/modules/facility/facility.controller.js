...
let FacilityController = (() => {
    let _classDecorators = [(0, common_1.Controller)('facilities')];
    ...
    var FacilityController = class {
        ...
        static {
            ...
            _createFacility_decorators = [(0, common_1.Post)()];
            _getFacilities_decorators = [(0, common_1.Get)()];
            _getFacility_decorators = [(0, common_1.Get)(':id')];
            _updateFacility_decorators = [(0, common_1.Put)(':id')];
            _deleteFacility_decorators = [(0, common_1.Delete)(':id')];
            _getFacilitySpaces_decorators = [(0, common_1.Get)(':id/spaces')];
            _getFacilityStaff_decorators = [(0, common_1.Get)(':id/staff')];
            _getFacilitySchedule_decorators = [(0, common_1.Get)(':id/schedule')];
