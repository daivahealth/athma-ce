...
let StaffController = (() => {
    let _classDecorators = [(0, common_1.Controller)('staff')];
    ...
    var StaffController = class {
        ...
        static {
            ...
            _createStaff_decorators = [(0, common_1.Post)()];
            _getStaff_decorators = [(0, common_1.Get)()];
            _getStaffById_decorators = [(0, common_1.Get)(':id')];
            _updateStaff_decorators = [(0, common_1.Put)(':id')];
            _deleteStaff_decorators = [(0, common_1.Delete)(':id')];
            _getStaffAvailability_decorators = [(0, common_1.Get)(':id/availability')];
            _getStaffSchedule_decorators = [(0, common_1.Get)(':id/schedule')];
