...
let HealthController = (() => {
    ...
    var HealthController = class {
        ...
        static {
            ...
            _getHealth_decorators = [(0, common_1.Get)(), (0, swagger_1.ApiOperation)({ summary: 'Health check endpoint' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Service is healthy' }), (0, swagger_1.ApiResponse)({ status: 503, description: 'Service is unhealthy' })];
            _getReadiness_decorators = [(0, common_1.Get)('ready'), (0, swagger_1.ApiOperation)({ summary: 'Readiness check endpoint' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Service is ready' }), (0, swagger_1.ApiResponse)({ status: 503, description: 'Service is not ready' })];
            _getLiveness_decorators = [(0, common_1.Get)('live'), (0, swagger_1.ApiOperation)({ summary: 'Liveness check endpoint' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Service is alive' })];
