...
export const emiratesIdSchema = z.string().regex(/^[0-9]{3}-[0-9]{4}-[0-9]{7}-[0-9]{1}$/, 'Invalid Emirates ID format');
// Pagination schemas
...
export const updateValidationSchema = (schema) => schema.partial();
export const queryValidationSchema = (schema) => schema.optional();
