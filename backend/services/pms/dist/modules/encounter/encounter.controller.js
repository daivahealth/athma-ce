...
let EncounterController = (() => {
    let _classDecorators = [Controller('encounters')];
    ...
    var EncounterController = class {
        ...
        static {
            ...
            _createEncounter_decorators = [Post()];
            _getEncounters_decorators = [Get()];
            _searchEncounters_decorators = [Get('search')];
            _getEncounterStats_decorators = [Get('stats')];
            _getEncounter_decorators = [Get(':id')];
            _updateEncounter_decorators = [Put(':id')];
            _deleteEncounter_decorators = [Delete(':id')];
            _startEncounter_decorators = [Post(':id/start')];
            _completeEncounter_decorators = [Post(':id/complete')];
            _cancelEncounter_decorators = [Post(':id/cancel')];
            _getClinicalNotes_decorators = [Get(':id/notes')];
            _createClinicalNote_decorators = [Post(':id/notes')];
            _updateClinicalNote_decorators = [Put('notes/:noteId')];
            _deleteClinicalNote_decorators = [Delete('notes/:noteId')];
            _signClinicalNote_decorators = [Post('notes/:noteId/sign')];
            _getVitals_decorators = [Get(':id/vitals')];
            _recordVitals_decorators = [Post(':id/vitals')];
            _updateVitals_decorators = [Put('vitals/:vitalId')];
            _getOrders_decorators = [Get(':id/orders')];
            _createOrder_decorators = [Post(':id/orders')];
            _updateOrder_decorators = [Put('orders/:orderId')];
            _cancelOrder_decorators = [Post('orders/:orderId/cancel')];
