...
let ClinicalController = (() => {
    let _classDecorators = [Controller('clinical')];
    ...
    var ClinicalController = class {
        ...
        static {
            ...
            _getTemplates_decorators = [Get('templates')];
            _createTemplate_decorators = [Post('templates')];
            _getMedications_decorators = [Get('medications')];
            _searchMedications_decorators = [Get('medications/search')];
            _getDiagnoses_decorators = [Get('diagnoses')];
            _searchDiagnoses_decorators = [Get('diagnoses/search')];
