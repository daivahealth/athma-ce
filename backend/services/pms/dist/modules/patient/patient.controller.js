...
let PatientController = (() => {
    let _classDecorators = [Controller('patients')];
    ...
    var PatientController = class {
        ...
        static {
            ...
            _createPatient_decorators = [Post()];
            _getPatients_decorators = [Get()];
            _searchPatients_decorators = [Get('search')];
            _getPatient_decorators = [Get(':id')];
            _updatePatient_decorators = [Put(':id')];
            _deletePatient_decorators = [Delete(':id')];
            _getPatientAppointments_decorators = [Get(':id/appointments')];
            _getPatientEncounters_decorators = [Get(':id/encounters')];
            _getPatientMedicalHistory_decorators = [Get(':id/medical-history')];
            _mergePatients_decorators = [Post(':id/merge')];
            _findDuplicatePatients_decorators = [Get(':id/duplicates')];
            _updatePatientConsent_decorators = [Post(':id/consent')];
            _getPatientTranslations_decorators = [Get(':id/translations')];
            _updatePatientTranslations_decorators = [Post(':id/translations')];
