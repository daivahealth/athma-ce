...
let CreateRoleDto = (() => {
    ...
    return class CreateRoleDto {
        static {
            ...
            _code_decorators = [ApiProperty({ description: 'Role code', example: 'physician' }), IsString(), MinLength(2), MaxLength(50)];
            _name_decorators = [ApiProperty({ description: 'Role name', example: 'Physician' }), IsString(), MinLength(2), MaxLength(100)];
            _description_decorators = [ApiPropertyOptional({ description: 'Role description' }), IsOptional(), IsString(), MaxLength(500)];
            _isSystem_decorators = [ApiPropertyOptional({ description: 'Is system role', default: false }), IsOptional(), IsBoolean()];
...
let UpdateRoleDto = (() => {
    ...
    return class UpdateRoleDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _name_decorators = [ApiPropertyOptional({ description: 'Role name', example: 'Physician' }), IsOptional(), IsString(), MinLength(2), MaxLength(100)];
            _description_decorators = [ApiPropertyOptional({ description: 'Role description' }), IsOptional(), IsString(), MaxLength(500)];
            __esDecorate(null, null, _name_decorators, { kind: "field", name: "name", static: false, private: false, access: { has: obj => "name" in obj, get: obj => obj.name, set: (obj, value) => { obj.name = value; } }, metadata: _metadata }, _name_initializers, _name_extraInitializers);
            __esDecorate(null, null, _description_decorators, { kind: "field", name: "description", static: false, private: false, access: { has: obj => "description" in obj, get: obj => obj.description, set: (obj, value) => { obj.description = value; } }, metadata: _metadata }, _description_initializers, _description_extraInitializers);
            if (_metadata) Object.defineProperty(this, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
...
let CreatePermissionDto = (() => {
    ...
    return class CreatePermissionDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _code_decorators = [ApiProperty({ description: 'Permission code', example: 'patients.read' }), IsString(), MinLength(3), MaxLength(100)];
            _name_decorators = [ApiProperty({ description: 'Permission name', example: 'Read Patients' }), IsString(), MinLength(2), MaxLength(150)];
            _description_decorators = [ApiPropertyOptional({ description: 'Permission description' }), IsOptional(), IsString(), MaxLength(500)];
            _resource_decorators = [ApiPropertyOptional({ description: 'Resource', example: 'patients' }), IsOptional(), IsString(), MaxLength(50)];
            _action_decorators = [ApiPropertyOptional({ description: 'Action', example: 'read' }), IsOptional(), IsString(), MaxLength(50)];
            __esDecorate(null, null, _code_decorators, { kind: "field", name: "code", static: false, private: false, access: { has: obj => "code" in obj, get: obj => obj.code, set: (obj, value) => { obj.code = value; } }, metadata: _metadata }, _code_initializers, _code_extraInitializers);
            __esDecorate(null, null, _name_decorators, { kind: "field", name: "name", static: false, private: false, access: { has: obj => "name" in obj, get: obj => obj.name, set: (obj, value) => { obj.name = value; } }, metadata: _metadata }, _name_initializers, _name_extraInitializers);
            __esDecorate(null, null, _description_decorators, { kind: "field", name: "description", static: false, private: false, access: { has: obj => "description" in obj, get: obj => obj.description, set: (obj, value) => { obj.description = value; } }, metadata: _metadata }, _description_initializers, _description_extraInitializers);
...
let AssignRoleDto = (() => {
    ...
    return class AssignRoleDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _userId_decorators = [ApiProperty({ description: 'User ID', example: '123e4567-e89b-12d3-a456-426614174000' }), IsUUID()];
            _roleId_decorators = [ApiProperty({ description: 'Role ID', example: '123e4567-e89b-12d3-a456-426614174000' }), IsUUID()];
            _assignedBy_decorators = [ApiPropertyOptional({ description: 'Assigned by user ID' }), IsOptional(), IsUUID()];
            _expiresAt_decorators = [ApiPropertyOptional({ description: 'Expiration date' }), IsOptional(), IsDateString()];
...
let RbacStatsDto = (() => {
    ...
    return class RbacStatsDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _totalRoles_decorators = [ApiProperty({ description: 'Total number of roles' })];
            _systemRoles_decorators = [ApiProperty({ description: 'Number of system roles' })];
            _customRoles_decorators = [ApiProperty({ description: 'Number of custom roles' })];
            _totalPermissions_decorators = [ApiProperty({ description: 'Total number of permissions' })];
            _totalRoleAssignments_decorators = [ApiProperty({ description: 'Total number of role assignments' })];
            _activeRoleAssignments_decorators = [ApiProperty({ description: 'Number of active role assignments' })];
