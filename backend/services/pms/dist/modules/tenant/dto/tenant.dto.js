...
let CreateTenantDto = (() => {
    ...
    return class CreateTenantDto {
        static {
            ...
            _name_decorators = [ApiProperty({ description: 'Tenant name', example: 'Al Rashid Medical Center' }), IsString(), MinLength(2), MaxLength(255)];
            _domain_decorators = [ApiProperty({ description: 'Tenant domain', example: 'alrashid.zeal.com' }), IsString(), MinLength(3), MaxLength(253), Matches(/^[a-zA-Z0-9][a-zA-Z0-9-]{0,61}[a-zA-Z0-9]?(\.[a-zA-Z0-9][a-zA-Z0-9-]{0,61}[a-zA-Z0-9]?)*$/, {
                    message: 'Invalid domain format'
                })];
            _settings_decorators = [ApiPropertyOptional({ description: 'Tenant settings', example: { timezone: 'Asia/Dubai', language: 'en' } }), IsOptional(), IsObject()];
...
let UpdateTenantDto = (() => {
    ...
    return class UpdateTenantDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _name_decorators = [ApiPropertyOptional({ description: 'Tenant name', example: 'Al Rashid Medical Center' }), IsOptional(), IsString(), MinLength(2), MaxLength(255)];
            _domain_decorators = [ApiPropertyOptional({ description: 'Tenant domain', example: 'alrashid.zeal.com' }), IsOptional(), IsString(), MinLength(3), MaxLength(253), Matches(/^[a-zA-Z0-9][a-zA-Z0-9-]{0,61}[a-zA-Z0-9]?(\.[a-zA-Z0-9][a-zA-Z0-9-]{0,61}[a-zA-Z0-9]?)*$/, {
                    message: 'Invalid domain format'
                })];
            _status_decorators = [ApiPropertyOptional({ description: 'Tenant status', enum: ['active', 'inactive', 'suspended'] }), IsOptional(), IsEnum(['active', 'inactive', 'suspended'])];
            _settings_decorators = [ApiPropertyOptional({ description: 'Tenant settings', example: { timezone: 'Asia/Dubai', language: 'en' } }), IsOptional(), IsObject()];
            __esDecorate(null, null, _name_decorators, { kind: "field", name: "name", static: false, private: false, access: { has: obj => "name" in obj, get: obj => obj.name, set: (obj, value) => { obj.name = value; } }, metadata: _metadata }, _name_initializers, _name_extraInitializers);
            __esDecorate(null, null, _domain_decorators, { kind: "field", name: "domain", static: false, private: false, access: { has: obj => "domain" in obj, get: obj => obj.domain, set: (obj, value) => { obj.domain = value; } }, metadata: _metadata }, _domain_initializers, _domain_extraInitializers);
...
let TenantSearchDto = (() => {
    ...
    return class TenantSearchDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _query_decorators = [ApiPropertyOptional({ description: 'Search query for name or domain' }), IsOptional(), IsString()];
...
let TenantStatsDto = (() => {
    ...
    return class TenantStatsDto {
        static {
            ...
            _totalPatients_decorators = [ApiProperty({ description: 'Total number of patients' })];
            _totalFacilities_decorators = [ApiProperty({ description: 'Total number of facilities' })];
            _totalStaff_decorators = [ApiProperty({ description: 'Total number of staff' })];
            _totalAppointments_decorators = [ApiProperty({ description: 'Total number of appointments' })];
            _activeAppointments_decorators = [ApiProperty({ description: 'Number of active appointments' })];
