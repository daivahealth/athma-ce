...
let CreateUserDto = (() => {
    ...
    return class CreateUserDto {
        static {
            ...
            _tenantId_decorators = [ApiProperty({ description: 'Tenant ID', example: '123e4567-e89b-12d3-a456-426614174000' }), IsUUID()];
            _email_decorators = [ApiProperty({ description: 'User email', example: 'john.doe@example.com' }), IsEmail()];
            _firstName_decorators = [ApiProperty({ description: 'First name', example: 'John' }), IsString(), MinLength(2), MaxLength(100)];
            _lastName_decorators = [ApiProperty({ description: 'Last name', example: 'Doe' }), IsString(), MinLength(2), MaxLength(100)];
            _password_decorators = [ApiProperty({ description: 'Password', example: 'SecurePassword123!' }), IsString(), MinLength(8), MaxLength(128)];
            _role_decorators = [ApiProperty({ description: 'User role', example: 'physician' }), IsString(), IsEnum(['admin', 'physician', 'nurse', 'billing_staff', 'receptionist'])];
            _permissions_decorators = [ApiPropertyOptional({ description: 'User permissions', example: { patients: ['read', 'write'], appointments: ['read'] } }), IsOptional(), IsObject()];
...
let UpdateUserDto = (() => {
    ...
    return class UpdateUserDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _firstName_decorators = [ApiPropertyOptional({ description: 'First name', example: 'John' }), IsOptional(), IsString(), MinLength(2), MaxLength(100)];
            _lastName_decorators = [ApiPropertyOptional({ description: 'Last name', example: 'Doe' }), IsOptional(), IsString(), MinLength(2), MaxLength(100)];
            _role_decorators = [ApiPropertyOptional({ description: 'User role', example: 'physician' }), IsOptional(), IsString(), IsEnum(['admin', 'physician', 'nurse', 'billing_staff', 'receptionist'])];
            _status_decorators = [ApiPropertyOptional({ description: 'User status', enum: ['active', 'inactive', 'suspended'] }), IsOptional(), IsEnum(['active', 'inactive', 'suspended'])];
            _permissions_decorators = [ApiPropertyOptional({ description: 'User permissions', example: { patients: ['read', 'write'], appointments: ['read'] } }), IsOptional(), IsObject()];
            __esDecorate(null, null, _firstName_decorators, { kind: "field", name: "firstName", static: false, private: false, access: { has: obj => "firstName" in obj, get: obj => obj.firstName, set: (obj, value) => { obj.firstName = value; } }, metadata: _metadata }, _firstName_initializers, _firstName_extraInitializers);
            __esDecorate(null, null, _lastName_decorators, { kind: "field", name: "lastName", static: false, private: false, access: { has: obj => "lastName" in obj, get: obj => obj.lastName, set: (obj, value) => { obj.lastName = value; } }, metadata: _metadata }, _lastName_initializers, _lastName_extraInitializers);
            __esDecorate(null, null, _role_decorators, { kind: "field", name: "role", static: false, private: false, access: { has: obj => "role" in obj, get: obj => obj.role, set: (obj, value) => { obj.role = value; } }, metadata: _metadata }, _role_initializers, _role_extraInitializers);
...
let UserSearchDto = (() => {
    ...
    return class UserSearchDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _query_decorators = [ApiPropertyOptional({ description: 'Search query for name or email' }), IsOptional(), IsString()];
            _role_decorators = [ApiPropertyOptional({ description: 'Filter by role', enum: ['admin', 'physician', 'nurse', 'billing_staff', 'receptionist'] }), IsOptional(), IsString(), IsEnum(['admin', 'physician', 'nurse', 'billing_staff', 'receptionist'])];
            _status_decorators = [ApiPropertyOptional({ description: 'Filter by status', enum: ['active', 'inactive', 'suspended'] }), IsOptional(), IsEnum(['active', 'inactive', 'suspended'])];
...
let ChangePasswordDto = (() => {
    ...
    return class ChangePasswordDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _currentPassword_decorators = [ApiProperty({ description: 'Current password' }), IsString()];
            _newPassword_decorators = [ApiProperty({ description: 'New password' }), IsString(), MinLength(8), MaxLength(128)];
...
let UserStatsDto = (() => {
    ...
    return class UserStatsDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _totalUsers_decorators = [ApiProperty({ description: 'Total number of users' })];
            _activeUsers_decorators = [ApiProperty({ description: 'Number of active users' })];
            _inactiveUsers_decorators = [ApiProperty({ description: 'Number of inactive users' })];
            _usersByRole_decorators = [ApiProperty({ description: 'Users by role' })];
            _recentLogins_decorators = [ApiProperty({ description: 'Number of recent logins (last 7 days)' })];
