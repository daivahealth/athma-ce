 ...
 * Mirrors the clinical service's guard of the same name; used by plugin-hosting
 * services to report plugin load status and query activations without a user JWT.
 */
@Injectable()
