# Complete Data Model (Legacy Reference)

> This document preserves the full data model from the earlier monolithic schema, including draft tables for RCM, billing, orders, catalogs, and other planned features. It is retained for archival/reference purposes and is **not** actively maintained.
# Data Model
