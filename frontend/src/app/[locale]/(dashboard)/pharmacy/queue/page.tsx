...
import type { DispensingChannel as DispensingChannelType } from '@/modules/pharmacy/types/dispensing';
                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-4 text-xs text-muted-foreground">
                            <span>
                              Prescribed:{' '}
                              {format(new Date(item.prescribedAt), 'dd MMM yyyy HH:mm')}
                            </span>
                            {item.wardName && (
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <Button
          ...
          variant="ghost"
          onClick={() =>
            router.push(`/${locale}/pharmacy/dispensings/${row.original.id}`)
          }
        >
